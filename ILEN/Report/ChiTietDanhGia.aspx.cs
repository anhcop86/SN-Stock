...
public partial class Report_ChuKyDanhGia : TrangKho
{
    ...
    protected void LoadListChuKy()
    {
            ...
            ListBieuMauSelect.DataSource = listVaiTro;
            ListBieuMauSelect.DataValueField = "MaCK";
            ListBieuMauSelect.DataTextField = "TenCK";
    ...
    {
        ReportRender(int.Parse(ListBieuMauSelect.SelectedValue));
