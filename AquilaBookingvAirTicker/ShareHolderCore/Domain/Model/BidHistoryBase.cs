...
namespace ShareHolderCore.Domain.Model
{
    public class BidHistoryBase
    {
        ...
        private IList<BidHistory> _listBidHistory;
        #endregion

        #region Constructors
        public BidHistoryBase() { }
        ...
        public virtual IList<BidHistory> BidHistory
        {
            get { return _listBidHistory; }
            set { _listBidHistory = value; }
        }
        #endregion
    }
    public enum BidHistoryColumns
    {
        ID,
        BidDate,
        ShareHolderId,
