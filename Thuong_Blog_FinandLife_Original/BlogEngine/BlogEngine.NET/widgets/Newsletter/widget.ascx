...
<div id="newsletterform">
  ...
  <label for="<%=txtEmail.ClientID %>" style="font-weight:bold; margin-left:76px;color:#006495"><%=Resources.labels.enterEmail %></label><br />
  <asp:TextBox runat="server" ID="txtEmail" Width="249px" />
